      ...
      <div className='d-flex flex-column bg-white p-4 rounded-2 align-items-lg-center'>
        ...
        <form action="">
          ...
          <div>
            ...
            <label htmlFor="show-password" className='mx-1' onClick={() => setShowPassword(prev => !prev)}>Показать
              пароль</label>
          </div>
          <Button className='w-100 mt-3' type='confirm' variant='contained'>Войти</Button>
        </form>
      </div>
